...
class Car(models.Model):
    ...
    gear=models.CharField(max_length=1,choices=GEAR) #database de performansı arttırıyor.
    rent_per_day=models.DecimalField(max_digits=7,decimal_places=2,validators=[MinValueValidator(1)])
